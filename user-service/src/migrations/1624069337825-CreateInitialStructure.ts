...
export class CreateInitialStructure1624069337825 implements MigrationInterface {
    name = 'CreateInitialStructure1624069337825'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "invite" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userSenderId" uuid, "userReceiverId" uuid, "confirmation_date" TIMESTAMP, "accepted" boolean NOT NULL DEFAULT false, "rejected" boolean NOT NULL DEFAULT false, "created_At" TIMESTAMP NOT NULL DEFAULT now(), "updated_At" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_fc9fa190e5a3c5d80604a4f63e1" PRIMARY KEY ("id"))`);
